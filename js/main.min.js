...
!function (e, t) {
    ...
    var n = [], i = Object.getPrototypeOf, o = n.slice, r = n.flat ? function (e) {
        ...
        }, g = e.document, y = {type: !0, src: !0, nonce: !0, noModule: !0};
    ...
    b.fn = b.prototype = {
        ...
        for ("boolean" == typeof s && (c = s, s = arguments[a] || {}, a++), "object" == typeof s || h(s) || (s = {}), a === l && (s = this, a--); a < l; a++) if (null != (e = arguments[a])) for (t in e) i = e[t], "__proto__" !== t && s !== i && (c && i && (b.isPlainObject(i) || (o = Array.isArray(i))) ? (n = s[t], r = o && !Array.isArray(n) ? [] : o || b.isPlainObject(n) ? n : {}, o = !1, s[t] = b.extend(c, r, i)) : void 0 !== i && (s[t] = i));
        return s
    }, b.extend({
 ...
 */
        function (e) {
            var t, n, i, o, r, s, a, l, c, d, u, p, f, h, v, g, y, m, w, b = "sizzle" + 1 * new Date, x = e.document,
                T = 0, k = 0, S = le(), C = le(), $ = le(), A = le(), E = function (e, t) {
                    return e === t && (u = !0), 0
                }, D = {}.hasOwnProperty, j = [], L = j.pop, N = j.push, H = j.push, O = j.slice, P = function (e, t) {
                ...
                z = "\\[" + M + "*(" + I + ")(?:" + M + "*([*^$|!~]?=)" + M + "*(?:'((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\"|(" + I + "))|)" + M + "*\\]",
                W = ":(" + I + ")(?:\\((('((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\")|((?:\\\\.|[^\\\\()[\\]]|" + z + ")*)|.*)\\)|)",
                R = new RegExp(M + "+", "g"), B = new RegExp("^" + M + "+|((?:^|[^\\\\])(?:\\\\.)*)" + M + "+$", "g"),
                F = new RegExp("^" + M + "*," + M + "*"), _ = new RegExp("^" + M + "*([>+~]|" + M + ")" + M + "*"),
                U = new RegExp(M + "|>"), X = new RegExp(W), Y = new RegExp("^" + I + "$"), G = {
                    ID: new RegExp("^#(" + I + ")"),
                    CLASS: new RegExp("^\\.(" + I + ")"),
                    TAG: new RegExp("^(" + I + "|[*])"),
                    ATTR: new RegExp("^" + z),
                ...
                }, V = /HTML$/i, Q = /^(?:input|select|textarea|button)$/i, J = /^h\d$/i, K = /^[^{]+\{\s*\[native \w/,
                Z = /^(?:#([\w-]+)|(\w+)|\.([\w-]+))$/, ee = /[+~]/,
                        ...
                        return 1 === i && 0 === o ? function (e) {
                            ...
                            if (g) {
                                ...
                                if (h = [s ? g.firstChild : g.lastChild], s && m) {
                                    for (w = (f = (c = (d = (u = (p = g)[b] || (p[b] = {}))[p.uniqueID] || (u[p.uniqueID] = {}))[e] || [])[0] === T && c[1]) && c[2], p = f && g.childNodes[f]; p = ++f && p && p[v] || (w = f = 0) || h.pop();) if (1 === p.nodeType && ++w && p === t) {
                                        d[e] = [T, f, w];
                                        break
                                    }
            ...
            function ke(e, t, n, i, o, r) {
                return i && !i[b] && (i = ke(i)), o && !o[b] && (o = ke(o, r)), ce((function (r, s, a, l) {
                    var c, d, u, p = [], f = [], h = s.length, v = r || function (e, t, n) {
                            ...
                            return n
                        }(t || "*", a.nodeType ? [a] : a, []), g = !e || !r && t ? v : Te(v, p, e, a, l),
                        y = n ? o || (r ? e : h || i) ? [] : s : g;
                    if (n && n(g, y, a, l), i) for (c = Te(y, f), i(c, [], a, l), d = c.length; d--;) (u = c[d]) && (y[f[d]] = !(g[f[d]] = u));
                    if (r) {
                        if (o || e) {
                            if (o) {
            ...
            function Se(e) {
                for (var t, n, o, r = e.length, s = i.relative[e[0].type], a = s || i.relative[" "], l = s ? 1 : 0, d = be((function (e) {
                    ...
                    return t = null, o
                }]; l < r; l++) if (n = i.relative[e[l].type]) p = [be(xe(p), n)]; else {
                    if ((n = i.filter[e[l].type].apply(null, e[l].matches))[b]) {
                        for (o = ++l; o < r && !i.relative[e[o].type]; o++) ;
                        return ke(l > 1 && xe(p), l > 1 && we(e.slice(0, l - 1).concat({value: " " === e[l - 2].type ? "*" : ""})).replace(B, "$1"), n, l < o && Se(e.slice(l, o)), o < r && Se(e = e.slice(o)), o < r && we(e))
                    }
                    p.push(n)
                }
                return xe(p)
            ...
            return me.prototype = i.filters = i.pseudos, i.setFilters = new me, s = ae.tokenize = function (e, t) {
                ...
                if (!a) {
                    ...
                    (a = $(e, function (e, t) {
                        var n = t.length > 0, o = e.length > 0, r = function (r, s, a, l, d) {
                            var u, h, g, y = 0, m = "0", w = r && [], b = [], x = c, k = r || o && i.find.TAG("*", d),
                                S = T += null == x ? 1 : Math.random() || .1, C = k.length;
                ...
                if (n = n || [], 1 === f.length) {
                    ...
                    for (r = G.needsContext.test(e) ? 0 : l.length; r-- && (c = l[r], !i.relative[d = c.type]);) if ((u = i.find[d]) && (o = u(c.matches[0].replace(te, ne), ee.test(l[0].type) && ye(t.parentNode) || t))) {
    ...
    (b.fn.init = function (e, t, n) {
        ...
        if (n = n || D, "string" == typeof e) {
            ...
            if (i[1]) {
                if (t = t instanceof b ? t[0] : t, b.merge(this, b.parseHTML(i[1], t && t.nodeType ? t.ownerDocument || t : g, !0)), A.test(i[1]) && b.isPlainObject(t)) for (i in t) h(this[i]) ? this[i](t[i]) : this.attr(i, t[i]);
                return this
            }
    ...
    b.fn.extend({
        has: function (e) {
            ...
            if (!C.test(e)) for (; i < o; i++) for (n = this[i]; n && n !== t; n = n.parentNode) if (n.nodeType < 11 && (s ? s.index(n) > -1 : 1 === n.nodeType && b.find.matchesSelector(n, e))) {
                r.push(n);
                break
            }
        ...
        b.fn[e] = function (n, i) {
            ...
            return "Until" !== e.slice(-5) && (i = n), i && "string" == typeof i && (o = b.filter(i, o)), this.length > 1 && (N[e] || b.uniqueSort(o), L.test(e) && o.reverse()), this.pushStack(o)
        }
    }));
    var O = /[^\x20\t\r\n\f]+/g;
    ...
    b.Callbacks = function (e) {
        ...
        var t, n, i, o, r = [], s = [], a = -1, l = function () {
            ...
            add: function () {
                ...
                return b.each(arguments, (function (e, t) {
                    for (var n; (n = b.inArray(t, r, n)) > -1;) r.splice(n, 1), n <= a && a--
                })), this
            }, has: function (e) {
        ...
        Deferred: function (t) {
                ...
                i = "pending", o = {
                    state: function () {
                            ...
                            return function () {
                                var a = this, l = arguments, c = function () {
                                    ...
                                    if (!(t < r)) {
                                        ...
                                        c = e && ("object" == typeof e || "function" == typeof e) && e.then, h(c) ? o ? c.call(e, s(r, n, P, o), s(r, n, q, o)) : (r++, c.call(e, s(r, n, P, o), s(r, n, q, o), s(r, n, P, n.notifyWith))) : (i !== P && (a = void 0, l = [e]), (o || n.resolveWith)(a, l))
                                    }
                                }, d = o ? c : function () {
                                    try {
                                        c()
                                    } catch (e) {
                                        b.Deferred.exceptionHook && b.Deferred.exceptionHook(e, d.stackTrace), t + 1 >= r && (i !== q && (a = void 0, l = [e]), n.rejectWith(a, l))
                                    }
                                };
                        ...
                        return b.Deferred((function (e) {
                            n[0][3].add(s(0, e, h(o) ? o : P, e.notifyWith)), n[1][3].add(s(0, e, h(t) ? t : P)), n[2][3].add(s(0, e, h(i) ? i : q))
                        })).promise()
                    }, promise: function (e) {
            ...
            var t = arguments.length, n = t, i = Array(n), r = o.call(arguments), s = b.Deferred(), a = function (e) {
                return function (n) {
    ...
    var R = function (e, t, n, i, o, r, s) {
        ...
        if ("object" === w(n)) for (a in o = !0, n) R(e, t, a, n[a], !0, r, s); else if (void 0 !== i && (o = !0, h(i) || (s = !0), c && (s ? (t.call(e, i), t = null) : (c = t, t = function (e, t, n) {
            return c.call(b(e), n)
    ...
    function U(e) {
        return e.replace(B, "ms-").replace(F, _)
    }
    ...
    var G = new Y, V = new Y, Q = /^(?:\{[\w\W]*\}|\[[\w\W]*\])$/, J = /[A-Z]/g;
    ...
    b.extend({
        ...
        queue: function (e, t, n) {
            ...
            t = t || "fx";
            var n = b.queue(e, t), i = n.length, o = n.shift(), r = b._queueHooks(e, t);
    ...
    var Z = /[+-]?(?:\d*\.|)\d+(?:[eE][+-]?\d+|)/.source, ee = new RegExp("^(?:([+-])=|)(" + Z + ")([a-z%]*)$", "i"),
        te = ["Top", "Right", "Bottom", "Left"], ne = g.documentElement, ie = function (e) {
    ...
    function ce(e, t) {
        for (var n, i, o = [], r = 0, s = e.length; r < s; r++) (i = e[r]).style && (n = i.style.display, t ? ("none" === n && (o[r] = G.get(i, "display") || null, o[r] || (i.style.display = "")), "" === i.style.display && re(i) && (o[r] = le(i))) : "none" !== n && (o[r] = "none", G.set(i, "display", n)));
    ...
    function we(e, t, n, i, o) {
        for (var r, s, a, l, c, d, u = t.createDocumentFragment(), p = [], f = 0, h = e.length; f < h; f++) if ((r = e[f]) || 0 === r) if ("object" === w(r)) b.merge(p, r.nodeType ? [r] : r); else if (me.test(r)) {
        ...
        for (u.textContent = "", f = 0; r = p[f++];) if (i && b.inArray(r, i) > -1) o && o.push(r); else if (c = ie(r), s = ge(u.appendChild(r), "script"), c && ye(s), n) for (d = 0; r = s[d++];) he.test(r.type || "") && n.push(r);
        return u
    }
        ...
        n ? (G.set(e, t, !1), b.event.add(e, t, {
            namespace: !1, handler: function (e) {
                ...
                if (1 & e.isTrigger && this[t]) {
                    if (s.length) (b.event.special[t] || {}).delegateType && e.stopPropagation(); else if (s = o.call(arguments), G.set(this, t, s), i = n(this, t), this[t](), s !== (r = G.get(this, t)) || i ? G.set(this, t, !1) : r = {}, s !== r) return e.stopImmediatePropagation(), e.preventDefault(), r && r.value
                } else s.length && (G.set(this, t, {value: b.event.trigger(b.extend(s[0], b.Event.prototype), s.slice(1), this)}), e.stopImmediatePropagation())
            }
        })) : void 0 === G.get(e, t) && b.event.add(e, t, xe)
    }

    b.event = {
        global: {}, add: function (e, t, n, i, o) {
            var r, s, a, l, c, d, u, p, f, h, v, g = G.get(e);
            if (X(e)) for (n.handler && (n = (r = n).handler, o = r.selector), o && b.find.matchesSelector(ne, o), n.guid || (n.guid = b.guid++), (l = g.events) || (l = g.events = Object.create(null)), (s = g.handle) || (s = g.handle = function (t) {
            ...
            if (g && (l = g.events)) {
                for (c = (t = (t || "").match(O) || [""]).length; c--;) if (f = v = (a = be.exec(t[c]) || [])[1], h = (a[2] || "").split(".").sort(), f) {
            ...
            var t, n, i, o, r, s, a = new Array(arguments.length), l = b.event.fix(e),
                c = (G.get(this, "events") || Object.create(null))[l.type] || [], d = b.event.special[l.type] || {};
            for (a[0] = l, t = 1; t < arguments.length; t++) a[t] = arguments[t];
            if (l.delegateTarget = this, !d.preDispatch || !1 !== d.preDispatch.call(this, l)) {
                for (s = b.event.handlers.call(this, l, c), t = 0; (o = s[t++]) && !l.isPropagationStopped();) for (l.currentTarget = o.elem, n = 0; (r = o.handlers[n++]) && !l.isImmediatePropagationStopped();) l.rnamespace && !1 !== r.namespace && !l.rnamespace.test(r.namespace) || (l.handleObj = r, l.data = r.data, void 0 !== (i = ((b.event.special[r.origType] || {}).handle || r.handler).apply(o.elem, a)) && !1 === (l.result = i) && (l.preventDefault(), l.stopPropagation()));
    ...
    var $e = /<script|<style|<link/i, Ae = /checked\s*(?:[^=]|=\s*.checked.)/i,
        Ee = /^\s*<!(?:\[CDATA\[|--)|(?:\]\]|--)>\s*$/g;
    ...
    function Ne(e, t) {
        var n, i, o, r, s, a;
        if (1 === t.nodeType) {
            if (G.hasData(e) && (a = G.get(e).events)) for (o in G.remove(t, "handle events"), a) for (n = 0, i = a[o].length; n < i; n++) b.event.add(t, o, a[o][n]);
            V.hasData(e) && (r = V.access(e), s = b.extend({}, r), V.set(t, s))
        }
    }
    ...
    function Oe(e, t, n, i) {
        ...
        if (p && (s = (o = we(t, e[0].ownerDocument, !1, e, i)).firstChild, 1 === o.childNodes.length && (o = s), s || i)) {
            ...
            if (l) for (d = a[a.length - 1].ownerDocument, b.map(a, Le), u = 0; u < l; u++) c = a[u], he.test(c.type || "") && !G.access(c, "globalEval") && b.contains(d, c) && (c.src && "module" !== (c.type || "").toLowerCase() ? b._evalUrl && !c.noModule && b._evalUrl(c.src, {nonce: c.nonce || c.getAttribute("nonce")}, d) : m(c.textContent.replace(Ee, ""), c, d))
        }
        return e
    }
    ...
    b.extend({
        htmlPrefilter: function (e) {
            ...
            if (!(f.noCloneChecked || 1 !== e.nodeType && 11 !== e.nodeType || b.isXMLDoc(e))) for (s = ge(a), i = 0, o = (r = ge(e)).length; i < o; i++) He(r[i], s[i]);
            if (t) if (n) for (r = r || ge(e), s = s || ge(a), i = 0, o = r.length; i < o; i++) Ne(r[i], s[i]); else Ne(e, a);
            return (s = ge(a, "script")).length > 0 && ye(s, !l && ge(e, "script")), a
        }, cleanData: function (e) {
            for (var t, n, i, o = b.event.special, r = 0; void 0 !== (n = e[r]); r++) if (X(n)) {
                if (t = n[G.expando]) {
                    if (t.events) for (i in t.events) o[i] ? b.event.remove(n, i) : b.removeEvent(n, i, t.handle);
                    n[G.expando] = void 0
                }
    ...
    var qe = new RegExp("^(" + Z + ")(?!px)[a-z%]+$", "i"), Me = function (t) {
    ...
    function We(e, t, n) {
        ...
        return (n = n || Me(e)) && ("" !== (s = n.getPropertyValue(t) || n[t]) || ie(e) || (s = b.style(e, t)), !f.pixelBoxStyles() && qe.test(s) && ze.test(t) && (i = a.width, o = a.minWidth, r = a.maxWidth, a.minWidth = a.maxWidth = a.width = s, s = n.width, a.width = i, a.minWidth = o, a.maxWidth = r)), void 0 !== s ? s + "" : s
    }
    ...
    var Be = ["Webkit", "Moz", "ms"], Fe = g.createElement("div").style, _e = {};

    function Ue(e) {
        var t = b.cssProps[e] || _e[e];
        return t || (e in Fe ? e : _e[e] = function (e) {
    ...
    function Ke(e, t, n) {
        var i = Me(e), o = (!f.boxSizingReliable() || n) && "border-box" === b.css(e, "boxSizing", !1, i), r = o,
            s = We(e, t, i), a = "offset" + t[0].toUpperCase() + t.slice(1);
        if (qe.test(s)) {
            if (!n) return s;
            s = "auto"
        }
    ...
    b.extend({
        ...
        css: function (e, t, n, i) {
            var o, r, s, a = U(t);
            return Ye.test(t) || (t = Ue(a)), (s = b.cssHooks[t] || b.cssHooks[a]) && "get" in s && (o = s.get(e, !0, n)), void 0 === o && (o = We(e, t, i)), "normal" === o && t in Ve && (o = Ve[t]), "" === n || n ? (r = parseFloat(o), !0 === n || isFinite(r) ? r || 0 : o) : o
        }
    }), b.each(["height", "width"], (function (e, t) {
        b.cssHooks[t] = {
            get: function (e, n, i) {
                if (n) return !Xe.test(b.css(e, "display")) || e.getClientRects().length && e.getBoundingClientRect().width ? Ke(e, t, i) : Ie(e, Ge, (function () {
                    return Ke(e, t, i)
                }))
            }, set: function (e, n, i) {
                var o, r = Me(e), s = !f.scrollboxSize() && "absolute" === r.position,
                    a = (s || i) && "border-box" === b.css(e, "boxSizing", !1, r), l = i ? Je(e, t, i, a, r) : 0;
    ...
    function lt(e, t, n) {
        ...
        for (!function (e, t) {
            var n, i, o, r, s;
            for (n in e) if (o = t[i = U(n)], r = e[n], Array.isArray(r) && (o = r[1], r = e[n] = r[0]), n !== i && (e[i] = r, delete e[n]), (s = b.cssHooks[i]) && "expand" in s) for (n in r = s.expand(r), delete e[i], r) n in e || (e[n] = r[n], t[n] = o); else t[i] = o
        }(d, c.opts.specialEasing); r < s; r++) if (i = lt.prefilters[r].call(c, e, d, c.opts)) return h(i.stop) && (b._queueHooks(c.elem, c.opts.queue).stop = i.stop.bind(i)), i;
    ...
    b.Animation = b.extend(lt, {
        tweeners: {
            ...
            var i, o, r, s, a, l, c, d, u = "width" in t || "height" in t, p = this, f = {}, h = e.style,
                v = e.nodeType && re(e), g = G.get(e, "fxshow");
            ...
            if ((l = !b.isEmptyObject(t)) || !b.isEmptyObject(f)) for (i in u && 1 === e.nodeType && (n.overflow = [h.overflow, h.overflowX, h.overflowY], null == (c = g && g.display) && (c = G.get(e, "display")), "none" === (d = b.css(e, "display")) && (c ? d = c : (ce([e], !0), c = e.style.display || c, d = b.css(e, "display"), ce([e]))), ("inline" === d || "inline-block" === d && null != c) && "none" === b.css(e, "float") && (l || (p.done((function () {
                h.display = c
            })), null == c && (d = h.display, c = "none" === d ? "" : d)), h.display = "inline-block")), n.overflow && (h.overflow = "hidden", p.always((function () {
                h.overflow = n.overflow[0], h.overflowX = n.overflow[1], h.overflowY = n.overflow[2]
            }))), l = !1, f) l || (g ? "hidden" in g && (v = g.hidden) : g = G.access(e, "fxshow", {display: c}), r && (g.hidden = !v), v && ce([e], !0), p.done((function () {
                for (i in v || ce([e]), G.remove(e, "fxshow"), f) b.style(e, i, f[i])
        ...
        fadeTo: function (e, t, n, i) {
            ...
            var o = b.isEmptyObject(e), r = b.speed(t, n, i), s = function () {
            ...
            return "string" != typeof e && (n = t, t = e, e = void 0), t && this.queue(e || "fx", []), this.each((function () {
                var t = !0, o = null != e && e + "queueHooks", r = b.timers, s = G.get(this);
                if (o) s[o] && s[o].stop && i(s[o]); else for (o in s) s[o] && s[o].stop && it.test(o) && i(s[o]);
                for (o = r.length; o--;) r[o].elem !== this || null != e && r[o].queue !== e || (r[o].anim.stop(n), t = !1, r.splice(o, 1));
                !t && n || b.dequeue(this, e)
            }))
        }, finish: function (e) {
            return !1 !== e && (e = e || "fx"), this.each((function () {
                var t, n = G.get(this), i = n[e + "queue"], o = n[e + "queueHooks"], r = b.timers, s = i ? i.length : 0;
    ...
    b.fn.extend({
        ...
        addClass: function (e) {
            ...
            if ((t = vt(e)).length) for (; n = this[l++];) if (o = ht(n), i = 1 === n.nodeType && " " + ft(o) + " ") {
            ...
            return "boolean" == typeof t && i ? t ? this.addClass(e) : this.removeClass(e) : h(e) ? this.each((function (n) {
                ...
                var t, o, r, s;
                if (i) for (o = 0, r = b(this), s = vt(e); t = s[o++];) r.hasClass(t) ? r.removeClass(t) : r.addClass(t); else void 0 !== e && "boolean" !== n || ((t = ht(this)) && G.set(this, "__className__", t), this.setAttribute && this.setAttribute("class", t || !1 === e ? "" : G.get(this, "__className__") || ""))
            }))
        }, hasClass: function (e) {
            var t, n, i = 0;
    ...
    b.extend(b.event, {
        trigger: function (t, n, i, o) {
            var r, s, a, l, c, u, p, f, y = [i || g], m = d.call(t, "type") ? t.type : t,
            ...
            if (s = f = a = i = i || g, 3 !== i.nodeType && 8 !== i.nodeType && !yt.test(m + b.event.triggered) && (m.indexOf(".") > -1 && (w = m.split("."), m = w.shift(), w.sort()), c = m.indexOf(":") < 0 && "on" + m, (t = t[b.expando] ? t : new b.Event(m, "object" == typeof t && t)).isTrigger = o ? 2 : 3, t.namespace = w.join("."), t.rnamespace = t.namespace ? new RegExp("(^|\\.)" + w.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, t.result = void 0, t.target || (t.target = i), n = null == n ? [t] : b.makeArray(n, [t]), p = b.event.special[m] || {}, o || !p.trigger || !1 !== p.trigger.apply(i, n))) {
                ...
                for (r = 0; (s = y[r++]) && !t.isPropagationStopped();) f = s, t.type = r > 1 ? l : p.bindType || m, (u = (G.get(s, "events") || Object.create(null))[t.type] && G.get(s, "handle")) && u.apply(s, n), (u = c && s[c]) && u.apply && X(s) && (t.result = u.apply(s, n), !1 === t.result && t.preventDefault());
    ...
    }), f.focusin || b.each({focus: "focusin", blur: "focusout"}, (function (e, t) {
        var n = function (e) {
    ...
    var wt = e.location, bt = {guid: Date.now()}, xt = /\?/;
    ...
    function $t(e, t, n, i) {
        ...
        })); else if (n || "object" !== w(t)) i(e, t); else for (o in t) $t(e + "[" + o + "]", t[o], n, i)
    }
    ...
    var At = /%20/g, Et = /#.*$/, Dt = /([?&])_=[^&]*/, jt = /^(.*?):[ \t]*([^\r\n]*)$/gm, Lt = /^(?:GET|HEAD)$/,
        Nt = /^\/\//, Ht = {}, Ot = {}, Pt = "*/".concat("*"), qt = g.createElement("a");
    ...
    qt.href = wt.href, b.extend({
        ...
        ajax: function (t, n) {
            ...
            var i, o, r, s, a, l, c, d, u, p, f = b.ajaxSetup({}, n), h = f.context || f,
                v = f.context && (h.nodeType || h.jquery) ? b(h) : b.event, y = b.Deferred(),
                m = b.Callbacks("once memory"), w = f.statusCode || {}, x = {}, T = {}, k = "canceled", S = {
                    readyState: 0, getResponseHeader: function (e) {
                        ...
                        var t;
                        if (e) if (c) S.always(e[S.status]); else for (t in e) w[t] = [w[t], e[t]];
                        return this
                    }, abort: function (e) {
                        var t = e || k;
            ...
            for (u in (d = b.event && f.global) && 0 == b.active++ && b.event.trigger("ajaxStart"), f.type = f.type.toUpperCase(), f.hasContent = !Lt.test(f.type), o = f.url.replace(Et, ""), f.hasContent ? f.data && f.processData && 0 === (f.contentType || "").indexOf("application/x-www-form-urlencoded") && (f.data = f.data.replace(At, "+")) : (p = f.url.slice(o.length), f.data && (f.processData || "string" == typeof f.data) && (o += (xt.test(o) ? "&" : "?") + f.data, delete f.data), !1 === f.cache && (o = o.replace(Dt, "$1"), p = (xt.test(o) ? "&" : "?") + "_=" + bt.guid++ + p), f.url = o + p), f.ifModified && (b.lastModified[o] && S.setRequestHeader("If-Modified-Since", b.lastModified[o]), b.etag[o] && S.setRequestHeader("If-None-Match", b.etag[o])), (f.data && f.hasContent && !1 !== f.contentType || n.contentType) && S.setRequestHeader("Content-Type", f.contentType), S.setRequestHeader("Accept", f.dataTypes[0] && f.accepts[f.dataTypes[0]] ? f.accepts[f.dataTypes[0]] + ("*" !== f.dataTypes[0] ? ", " + Pt + "; q=0.01" : "") : f.accepts["*"]), f.headers) S.setRequestHeader(u, f.headers[u]);
    ...
    var Wt = {0: 200, 1223: 204}, Rt = b.ajaxSettings.xhr();
    f.cors = !!Rt && "withCredentials" in Rt, f.ajax = Rt = !!Rt, b.ajaxTransport((function (t) {
        ...
        if (f.cors || Rt && !t.crossDomain) return {
            send: function (o, r) {
                ...
                n = function (e) {
                    return function () {
                        n && (n = i = a.onload = a.onerror = a.onabort = a.ontimeout = a.onreadystatechange = null, "abort" === e ? a.abort() : "error" === e ? "number" != typeof a.status ? r(0, "error") : r(a.status, a.statusText) : r(Wt[a.status] || a.status, a.statusText, "text" !== (a.responseType || "text") || "string" != typeof a.responseText ? {binary: a.response} : {text: a.responseText}, a.getAllResponseHeaders()))
                    }
    ...
    b.ajaxSetup({
        ...
        if (a || "jsonp" === t.dataTypes[0]) return o = t.jsonpCallback = h(t.jsonpCallback) ? t.jsonpCallback() : t.jsonpCallback, a ? t[a] = t[a].replace(_t, "$1" + o) : !1 !== t.jsonp && (t.url += (xt.test(t.url) ? "&" : "?") + t.jsonp + "=" + o), t.converters["script json"] = function () {
            ...
            void 0 === r ? b(e).removeProp(o) : e[o] = r, t[o] && (t.jsonpCallback = n.jsonpCallback, Ft.push(o)), s && h(r) && r(s[0]), s = r = void 0
        })), "script"
    })), f.createHTMLDocument = ((Bt = g.implementation.createHTMLDocument("").body).innerHTML = "<form></form><form></form>", 2 === Bt.childNodes.length), b.parseHTML = function (e, t, n) {
        ...
        b.cssHooks[t] = Re(f.pixelPosition, (function (e, n) {
            if (n) return n = We(e, t), qe.test(n) ? b(e).position()[t] + "px" : n
        }))
    ...
    $(".gallery__list").slick({
        ...
        dots: !0,
        responsive: [{breakpoint: 960, settings: {slidesToShow: 2}}, {breakpoint: 660, settings: {slidesToShow: 1}}]
    }), $(".tab").on("click", (function (e) {
        e.preventDefault(), $($(this).siblings()).removeClass("tab--active"), $($(this).parent().next().children()).removeClass("tabs-content--active"), $(this).addClass("tab--active"), $($(this).parent().next().find($(this).attr("href"))).addClass("tabs-content--active")
